...
public class EmployeeController {
  ...
  private EmployeeRepository employeeRepository;
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable("empId")  int empId, @RequestBody Employee employeeDetails) {
		Employee employee = employeeRepository.findById(empId).orElseThrow(()-> new EmployeeNotFoundException("Employee with Employee Id "+empId+" does not exist"));
	...
	public ResponseEntity<Map<String,Boolean>> deleteEmployee(@PathVariable("empId") int empId) {
		Employee employee = employeeRepository.findById(empId).orElseThrow(()-> new EmployeeNotFoundException("Employee with Employee Id "+empId+" does not exist"));
